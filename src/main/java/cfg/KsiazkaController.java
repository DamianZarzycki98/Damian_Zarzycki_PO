...
public class KsiazkaController implements Initializable {
    ...
    private void ksiazkaTableView() {
        try{
            ...
            String query = "SELECT CONCAT(autor.Imie,' ',autor.Nazwisko) AS aImNa, Id_Ksiazki, ksiazka.Id_Autora, ksiazka.Id_Wydawnictwa, Tytul, Rok_Wydania,wydawnictwo.Nazwa_Wydawnictwa FROM ksiazka INNER JOIN autor ON ksiazka.Id_Autora=autor.Id_Autora INNER JOIN wydawnictwo ON ksiazka.Id_Wydawnictwa=wydawnictwo.Id_Wydawnictwa";
